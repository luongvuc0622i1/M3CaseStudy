...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/client/assets/page/shop/css/shopCreatFood.css">
    ...
    <div id="right-content" style="margin-top: 30px">
      <form method="post" action="/shop">
        <div class="form-group input-group" style="position: static">
          ...
          <input name="food_name" class="form-control" placeholder="Tên Món Ăn" type="text" style="position: static">
        </div> <!-- form-group// -->
          <div class="form-group input-group" style="position: static">
            <div class="input-group-prepend">
              <span class="input-group-text"> <i class="fa fa-info"></i> </span>
            </div>
            <input name="food_price" class="form-control" placeholder="Giá" type="text" style="position: static">
          </div> <!-- form-group// -->
            <div class="form-group input-group" style="position: static">
              <div class="input-group-prepend">
                <span class="input-group-text"> <i class="fa fa-info"></i> </span>
              </div>
              <input name="food_description" class="form-control" placeholder="Miêu Tả" type="text" style="position: static">
            </div> <!-- form-group// -->
              ...
              <div class="form-group input-group" style="position: static">
                ...
                <input name="food_img" class="form-control" placeholder="Link Ảnh" type="text" style="position: static">
              </div> <!-- form-group// -->
                ...
                <div class="form-group input-group" style="position: static">
                  ...
                  <input name="food_cooktime" class="form-control" placeholder="Thời Gian Chuẩn Bị" type="text" style="position: static">
                </div> <!-- form-group// -->
        ...
        <div class="form-group input-group" style="position: static">
          ...
          <select class="custom-select" style="position: static" name="tags_id">
        ...
        <div class="form-group input-group" style="position: static">
          ...
          <select class="custom-select" style="position: static" name="deal_id" >
            <c:forEach var="deal" items="${deals}">
              <option value="<c:out value="${deal.id}"/>"><c:out value="${deal.name}"/></option>
            </c:forEach>
          </select>
        </div> <!-- form-group end.// -->

        <div class="form-group" style="position: static">
          <button type="reset" class="btn btn-primary btn-block" style="position: static">Reset</button>
          <button type="submit" class="btn btn-primary btn-block" style="position: static">Tạo Mới</button>
        </div> <!-- form-group// -->
      </form>
    </div>
  </div>
