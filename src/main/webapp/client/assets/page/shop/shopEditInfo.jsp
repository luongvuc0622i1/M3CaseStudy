...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="/client/assets/page/shop/css/shopEditInfo.css">
                    ...
                    <div class="card-body">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <input type="text" class="form-control" value="${shop.name}" name="shop_name">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <input type="text" class="form-control" value="${shop.email}" name="shop_email">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <input type="text" class="form-control" value="${shop.address}" name="shop_address">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <input type="text" class="form-control" value="${shop.phone}" name="shop_phone">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-sm-3">
                          <h6 class="mb-0">URL ảnh</h6>
                        </div>
                        <div class="col-sm-9 text-secondary">
                          <input type="text" class="form-control" value="${shop.image}" name="shop_image">
                        </div>
                      </div>
                      <div class="row mb-3">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-9 text-secondary">
                          <input type="text" class="form-control" value="${shop.description}" name="shop_description">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-sm-3"></div>
                        <div class="col-sm-9 text-secondary">
                          <input type="reset" class="btn btn-primary px-4" value="Đặt lại">
