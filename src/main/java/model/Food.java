...
public class Food {
    ...
    public Food(int id, int shop_id, int tag_id, int deal_id, String name, String description, String image, double price, Time cookTime, Date dayCreate, Date lastUpdate, int status) {
        this.id = id;
        this.shop_id = shop_id;
        this.tag_id = tag_id;
        this.deal_id = deal_id;
